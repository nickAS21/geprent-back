...
public class AuthenticationService {
    ...
    private final transient MimeMessage message;
    ...
    public ResponseEntity<?> forgotUser(final LoginForgotPasswordDTO loginForgot,
        ...
        try {
            sendmail( geoRentUser.getEmail(), getMultipartForgot (loginForgot.getUrl()));
    ...
    private Multipart getMultipartForgot (String url) throws MessagingException, IOException {
        ...
        messageUrlPart.setContent(Message.MAIL_SENT_BODY_TXT.getDescription() + Message.MAIL_SENT_BODY_TXT_LINK.getDescription() + content, "text/html; charset=utf-8");
